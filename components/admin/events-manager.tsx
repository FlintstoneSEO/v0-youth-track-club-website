            ...
            <DialogHeader>
              ...
              <DialogDescription>
                {editingEvent 
                  ...
                  : 'Create a new track meet or club event'
                }
              </DialogDescription>
            </DialogHeader>
              ...
              <FieldGroup>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Field>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="meet">Track Meet</SelectItem>
                ...
                <Field>
                  ...
                  <Input
                    ...
                    placeholder="e.g., Lansing Eastern High School"
                  />
                </Field>
                <Field>
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`text-xs px-2 py-0.5 rounded-full capitalize ${
                      event.event_type === 'meet' ? 'bg-blue-100 text-blue-700' :
